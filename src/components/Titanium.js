    ...
    <section className="common-padding w-full h-full">
      <div className='flex flex-col leading-none'>
        <div className="screen-max-width py-12">
          <div className="titanium flex flex-col items-center relative text-[#c8c2bd] md:text-8xl text-5xl lg:mb-10 mb-16 font-semibold leading-none">
        ...
        <div className='text-section h-[40vh] flex xl:flex-row flex-col items-center justify-center gap-10 max-sm:mt-40'>
          <p className="text-xl animation opacity-0 translate-y-[6rem] md:text-xl xl:w-[25%] font-medium text-gray-100 px-25">
